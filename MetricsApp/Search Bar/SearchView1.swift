...
class SearchView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        searchBase = UIView(frame: CGRect(x: 0, y: 0, width: screenWidth/2 - offset, height: 30))
        searchBase.backgroundColor = .red
        self.addSubview(searchBase)
//        NSLayoutConstraint.on([
//            searchBase.pinTop(view: searchBase, refView: self, thisConstant: 0),
////            searchBase.pinWH(size: CGSize(width: searchBase.frame.size.width, height: searchBase.frame.size.height)),
//            searchBase.pinLeft(view: searchBase, refView: self, thisConstant: 0)
//        ])
        
        selectionBase = UIView(frame: CGRect(x: searchBase.frame.size.width + offset, y: 0, width: screenWidth/2 - offset, height: 30))
...
////            selectionBase.pinRight(view: selectionBase, refView: self, thisConstant: 0)
//            selectionBase.pinLeft(view: selectionBase, refView: searchBase, thisConstant: 10)
////            selectionBase.pinWH(size: CGSize(width: selectionBase.frame.size.width, height: 30))
//        ])
         ...
         NSLayoutConstraint.on([
            ...
            searchBase.pinLeft(view: searchBase, refView: self, thisConstant: 0),
            selectionBase.pinRight(view: selectionBase, refView: searchBase, thisConstant: 10),
